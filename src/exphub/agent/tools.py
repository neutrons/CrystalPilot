"""LangChain tools the CrystalPilot agent can call.

The tools are intentionally thin — they capture the LLM's intent and return
structured data that the Agent validator processes further.
"""
...
# ---------------------------------------------------------------------------
# Global schema dict populated by the Agent at init time
# ---------------------------------------------------------------------------
_SCHEMA_PROPERTIES: dict[str, dict] = {}
...
def get_default_value(parameter_name: str) -> str:
    ...
    info = _SCHEMA_PROPERTIES.get(parameter_name, {})
