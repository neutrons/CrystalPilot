...
############################### coverage figure update ###########################################################
    ...
    def optimize_angleplan(self):
        ...
        if self.model.experimentinfo.pointGroup == "23":
            final_angle_list=[(0,135,0), (30, 135, 100)]
        ...
        if self.model.experimentinfo.pointGroup ==    "23"        :
              final_angle_list=[ (142.0, 135,140.0),(145.0, 135,152.0),(157.0, 135,190.0),(190.0, 135,220.0),(191.0, 135,215.0),(188.0, 135,255.0), ]

        if self.model.experimentinfo.pointGroup ==    "m-3"        :
              final_angle_list=[                    (115.0, 135,264.0),(128.0, 135,301.0),(155.0, 135,309.0),(164.0, 135,348.0),(170.0, 135,355.0),(204.0, 135,10.0),
                     (243.0, 135,24.0),(251.0, 135,49.0),(288.0, 135,55.0),(296.0, 135,81.0),(321.0, 135,88.0),(328.0, 135,103.0),
                          (73.0, 135,78.0),(91.0, 135,97.0),(127.0, 135,106.0),(153.0, 135,130.0),(156.0, 135,130.0),(181.0, 135,165.0), ]

        if self.model.experimentinfo.pointGroup ==    "-43m"        :
              final_angle_list=[                         (155.0, 135,229.0),(170.0, 135,255.0),(187.0, 135,272.0),(235.0, 135,286.0),(218.0, 135, 320.0),(255.0, 135,357.0), ]

        if self.model.experimentinfo.pointGroup ==    "m-3m"        :
              final_angle_list=[                          (333.0, 135,101.0),(2.0, 135,140.0),(1.0, 135,151.0),(38.0, 135,185.0),(57.0, 135,190.0),(82.0, 135,208.0),
                          (200.0, 135,324.0),(215.0, 135,337.0),(234.0, 135,1.0),(262.0, 135,32.0),(265.0, 135,52.0),(277.0, 135,77.0),(317.0, 135,78.0),(324.0, 135,116.0)]
